...
max_steps_list = [20000] # how many ATDDMRG time steps to do, this needs to be the same size as the tau list
...
project_number = 10 # <==================================== Important to change according to which project file ================================
    ...
    for filepath in os.listdir(f'{path_to_project}/DAGS/{project_number}/HDF5'):
        ...
        for i in range(len(step_num_list)):
            ...
            if max(N_list) <= 8:
                ...
                step, D, pn = step_num_list[i], max_bond_list[i], particle_number_density[i]
