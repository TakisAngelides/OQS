...
N_list = [50]
tau_list = [10**(-pow) for pow in [4]] # time step size
...
cutoff_list = [1e-16, 1e-17, 1e-18] # this is for compression after gate application
tol_list = [1E-16] # tol for dmrg stopping condition
x_list = [np.round(np.pi/3, 6)] # [np.round(1/0.8**2, 6)]
ma_list = [4.5]
l_0_list = [0, 4.14447317, 8.28894633, 12.4334195, 16.57789267, 20.72236584]
...
project_number = 7 # <==================================== Important to change according to which project file ================================
