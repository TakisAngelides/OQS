...
N_list = [20]
tau_list = [0.0001, 0.00005] # time step size
...
max_steps_list = [60000, 120000] # how many ATDDMRG time steps to do, this needs to be the same size as the tau list
measure_every_list = [1000, 2000] # how often to measure observables and store the density matrix, this needs to be the same size as the max_steps_list
cutoff_list = [1e-10, 1e-11, 1e-12] # this is for compression after gate application
