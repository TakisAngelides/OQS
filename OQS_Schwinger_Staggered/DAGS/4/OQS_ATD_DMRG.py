...
max_steps_list = [5] # how many ATDDMRG time steps to do 
cutoff_list = [1e-6, 1e-11] # this is for compression after gate application
l_0_list = [0.45]
tol_list = [1E-16] # tol for dmrg stopping condition
x_list = [1.56] # [np.round(1/0.8**2, 6)]
ma_list = [0.5]
...
project_number = 4 # <==================================== Important to change according to which project file ================================
