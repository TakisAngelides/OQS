...
max_steps_list = [2000] # how many ATDDMRG time steps to do, this needs to be the same size as the tau list
...
def make_plots():
    ...
    for filepath in os.listdir(f'{path_to_project}/DAGS/{project_number}/HDF5'):
        ...
        plt.plot(step_num_list[0:500], particle_number_density[0:500])
