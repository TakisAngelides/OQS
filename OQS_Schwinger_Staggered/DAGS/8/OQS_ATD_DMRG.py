...
N_list = [8]
tau_list = [10**(-pow) for pow in [2]] # time step size
...
max_steps_list = [10000] # how many ATDDMRG time steps to do, this needs to be the same size as the tau list
...
project_number = 8 # <==================================== Important to change according to which project file ================================
