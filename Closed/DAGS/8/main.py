...
def write_dag():
    ...
    for N in [100]:
        flip_sites = [39, 54] # this is for the case when the initial state is the dirac vacuum with a string and specifies where the string should be placed
        for x in x_list:
                for ma in ma_list:
