...
def write_dag():
    ...
    lambd = 0
    number_of_time_steps_list = [800, 2000, 4000] # needs same length as tau list
    x_list = [1/(0.36)**2, 1/(2)**2, 1/(0.8)**2]
    ma_list = [0.17, 1, 3]
    tau_list = [0.01, 0.01, 0.01]
    ...
    for N in [12]:
        ...
        for tau_idx, tau in enumerate(tau_list):
            x, ma = x_list[tau_idx], ma_list[tau_idx]
