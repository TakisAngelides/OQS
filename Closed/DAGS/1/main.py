...
def write_dag():
    ...
    maxdim = 500
    how_many_states_to_save = 3
    which_applied_field = "constant" # options are: "constant", "sauter", "gaussian", "oscillatory" and make sure the extra required inputs are also included according to this choice
