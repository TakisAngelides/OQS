...
def write_dag():
    ...
    for N in [12]:
        ...
        for aT in np.linspace(7, 100, 20):
            for x in x_list:
                for ma in ma_list:
                    for aD in aD_list:
    ...
    for file in os.listdir(path_to_HDF5):
        ...
        try:
            ...
            if attributes_dict['wis'] == 'dirac_vacuum_with_string':
                ...
                sns.heatmap(z_q, vmin = -1, vmax = 1, yticklabels = y_q)
                num_xticks_to_display = 10
...
def get_thermalization_times():
    ...
    for file in os.listdir(path_to_HDF5):
        ...
        try:
            ...
            if attributes_dict['wis'] == 'dirac_vacuum_with_string':
                ...
                with open(f'Plots/Thermalization_Heatmap/{ma}_{l_0_1}_{aD}_{aT}.pickle', 'wb') as f:
                    pickle.dump(thermalization_time, f)
    ...
    # plt.plot(ma_list, thermalization_time_list, '-o')
    # plt.savefig(f'Plots/Thermalization_Heatmap/thermalization_times.png')
    
    # aT_list, thermalization_time_list = zip(*sorted(zip(aT_list, thermalization_time_list)))
    # plt.scatter(aT_list, thermalization_time_list)
    # plt.savefig(f'Plots/Thermalization_Heatmap/thermalization_times_{2.0}_{0.0}_{1.0}.png')
    ...
    for file in os.listdir(path_to_HDF5):
        ...
        try:
            ...
            if attributes_dict['wis'] == 'dirac_vacuum_with_string':
                ...
                if str(aD) != '5':
                    continue
                if str(aT) != '7.0' and str(aT) != '100.0':
                    continue
                if str(ma) != '1.0':
                    continue
                # print(l_0_1, aD)
                ...
                # plt.savefig(f'Plots/EF/{file[:-3]}.png')
                # plt.close()
                with open(f'Plots/data/EF_{ma}_{l_0_1}_{aD}_{aT}.pickle', 'wb') as f:
                    pickle.dump(z, f)
                ...
                # plt.savefig(f'Plots/Q/{file[:-3]}.png')
                # plt.close()
                with open(f'Plots/data/Q_{ma}_{l_0_1}_{aD}_{aT}.pickle', 'wb') as f:
                    pickle.dump(z_q, f)
                ...
                # plt.savefig(f'Plots/PN/{file[:-3]}.png')
                # plt.close()
                with open(f'Plots/data/PN_{ma}_{l_0_1}_{aD}_{aT}.pickle', 'wb') as f:
                    pickle.dump(pn, f)
                ...
                # plt.savefig(f'Plots/E/{file[:-3]}.png')
                # plt.close()
                with open(f'Plots/data/E_{ma}_{l_0_1}_{aD}_{aT}.pickle', 'wb') as f:
                ...
                # plt.savefig(f'Plots/ME/{file[:-3]}.png')
                # plt.close()
                with open(f'Plots/data/ME_{ma}_{l_0_1}_{aD}_{aT}.pickle', 'wb') as f:
                ...
                # plt.savefig(f'Plots/KE/{file[:-3]}.png')
                # plt.close()
                with open(f'Plots/data/KE_{ma}_{l_0_1}_{aD}_{aT}.pickle', 'wb') as f:
                ...
                # plt.savefig(f'Plots/EFE/{file[:-3]}.png')
                # plt.close()
                with open(f'Plots/data/EFE_{ma}_{l_0_1}_{aD}_{aT}.pickle', 'wb') as f:
