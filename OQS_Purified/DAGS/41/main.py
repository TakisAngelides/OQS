...
def plot_ef_symmetry():
    ...
    for file in os.listdir(path_to_HDF5):
        ...
        if attributes_dict['wis'] == 'dirac_vacuum_with_string':
            ...
            ax_top.set_ylabel("Link", fontsize=16)
            ...
            ax_top.set_yticklabels([str(tick) for tick in full_links], fontsize=16)
            ...
            ax_middle.set_ylabel("Link", fontsize=16)
            ax_middle.tick_params(axis='both', labelsize=16)
            ...
            ax_middle.set_yticklabels([str(tick) for tick in middle_links], fontsize=16)
            ...
            ax_bottom.set_xlabel("$t$", fontsize=16)
            ax_bottom.set_xlim(0, 3.5)
            ax_bottom.set_ylabel("$|$SEF($i$) - SEF($N-i-2$)$|$", fontsize=16)
            ...
            ax_bottom.set_yticklabels([f"{tick:.1e}" for tick in y_ticks_bottom], fontsize=16)
            ...
            fig.text(0.93, 0.73, r'$(a)$', ha='center', fontsize=16)
            fig.text(0.93, 0.48, r'$(b)$', ha='center', fontsize=16)
            fig.text(0.93, 0.2, r'$(c)$', ha='center', fontsize=16)
